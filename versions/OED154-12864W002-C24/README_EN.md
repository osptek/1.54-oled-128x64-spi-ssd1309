...
<p align="center"><b>Monochrome OLED panel · SPI · SSD1309</b></p>
...
<p align="center"><img alt="OSPTEK 1.54″ OLED 128×64 panel (SSD1309) product image" src="./images/product.png" width="640" /></p>
...
OSPTEK **1.54″ 128×64 OLED** is a **SPI** monochrome panel driven by **SSD1309**. This branch covers the **screen datasheet**; the companion module is on branch [`ODM154-12864W001-P7`](https://github.com/osptek/1.54-oled-128x64-spi-ssd1309/tree/ODM154-12864W001-P7).
...
Current panel version: **OED154-12864W002-C24**. Electrical and mechanical details follow [`docs/OED154-12864W002-C24.pdf`](./docs/OED154-12864W002-C24.pdf).
...
```text
1.54-oled-128x64-spi-ssd1309/                                # repo root (nav: ../../README_EN.md)
└── versions/
    └── OED154-12864W002-C24/                                # full materials for this part number
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
