...
<p align="center"><b>单色 OLED 屏幕 · SPI · SSD1309</b></p>
...
<p align="center"><img alt="OSPTEK 1.54 寸 OLED 128×64 屏幕（SSD1309）宣传图" src="./images/product.png" width="640" /></p>
...
OSPTEK **1.54 寸 128×64 OLED** 屏幕为 **SPI** 单色面板，驱动芯片为 **SSD1309**。本分支为**单屏**规格。

规格标识（仓库名）：`1.54-oled-128x64-spi-ssd1309`

> 规格书中驱动 IC 可能标注为 **SPD0301**：与 **SSD1309** 为同一芯片族的不同料号，**软件完全兼容**；本仓库统一按 **SSD1309** 命名。

当前屏幕版本：**OED154-12864W002-C24**。电气与外形细节以 [`docs/OED154-12864W002-C24.pdf`](./docs/OED154-12864W002-C24.pdf) 为准。
...
```text
1.54-oled-128x64-spi-ssd1309/                                # 仓库根（导航见 ../../README.md）
└── versions/
    └── OED154-12864W002-C24/                                # 本料号完整资料
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
